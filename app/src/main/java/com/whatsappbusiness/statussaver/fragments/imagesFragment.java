...
//            Toast.makeText(getContext(), String.valueOf(Thread.currentThread().getId()), Toast.LENGTH_SHORT).show();
    ...
    private void setupRecyclerView(ArrayList<imagesModals> imageList) {
        ...
        recyclerAdaptor adaptor = new recyclerAdaptor(imageList, getContext(), 1);
